...
public class Expert extends Artiste{
    ...
    public Expert(int code, int codeCirque, String nom, String prenom, String dateNaissance, String  adresse, ArrayList<Numero> listeNumero, Theme theme, String numTel) {
